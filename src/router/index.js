...
const MemberContainer = () => import('@/containers/MemberContainer')

// Views
//const Dashboard = () => import('@/views/Dashboard')
const Country = () => import('@/views/setup/default/country')
const StatusFlag = () => import('@/views/setup/default/statusflag')
const currency = () => import('@/views/setup/default/currency')
const businessstatus = () => import('@/views/setup/default/businessstatus')

const TradeTerm = () => import('@/views/setup/default/tradeterm')


const Role = () => import('@/views/setup/authorization/role')
const Approval = () => import('@/views/setup/authorization/approval')
const roleapprovalstep = () => import('@/views/setup/authorization/roleapprovalstep')

const Paymenttype = () => import('@/views/setup/financial/paymenttype')
const duedatetype = () => import('@/views/setup/financial/duedatetype')

const Packing = () => import('@/views/setup/product/packing')
  ...
  routes: [
...

    {
      ...
      children: [
        ...
        {
          path: '/setup/authorization/role', /**        authorization  */
          name: 'authorization',
          component: {
            render(c) { return c('router-view') }
          },
