<template>
  <div v-show="o_grid_visible" class="grid">
    ...
    <div class="navbar navbar-light bg-default pt-3 pb-3" v-if="o_nav_visible">
      <div defualt-btn v-if="btnDefault">
      ...
      <slot name="nav" :selected="selected"></slot>

      <div left-btn>
        <slot name="nav-left" :selected="selected"></slot>
        ...
        <b-dropdown class="btnGrid navbar-toggler" variant="default" right no-caret>
          ...
          <b-dropdown-form class="dropdown-form-customer">
            <b-form-checkbox v-model="grid_responsive" @change="onColChange" switch inline></b-form-checkbox>
    ...
    <div class="pl-3 pr-3">
      <div :class="{'table-responsive': grid_responsive}" @scroll="onScroll">
        <!--table-bordered-->
        <table
          ...
          >
            <template v-for="(item, itemIndex) in visibleData">
              ...
              >
                              ...
                              >
                                ...
                                <template>
                                  ...
                                  >
                                    ...
                                    <template v-else>
                                      <slot :name="field3.name" :item="item" :itemIndex="itemIndex">
                ...
                <template v-else>
                  <td v-if="o_row_drag" class="handle text-center">
                  ...
                  >
                    <div class="d-flex justify-content-center">
                      ...
                      >
                        <label class="custom-control-label" :class="{'checked': rowSelected(item)}"></label>
                      </div>
                    </div>
                  </td>
                  <td
    ...
    <div class="navbar navbar-light bg-default footer" v-if="o_navfooter_visible">
